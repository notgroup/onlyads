    ...
    <div class="container-fluid">
      ...
      <div class="page-title-box">
        <div class="row align-items-center">
          <div class="col-sm-6">
            <h4 class="page-title">ProductGroupList</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-right">
              <li class="breadcrumb-item"><a href="javascript:void(0);">AnaSayfa</a></li>
              <li class="breadcrumb-item active">ProductGroupList</li>
            </ol>
          </div>
        </div>
        <!-- end row -->
              ...
              <tr v-for="(item, itemi) in items">
                ...
                <td>
                  <div class="btn-group btn-group">
                   ...
                   <button @click="$router.push('/ProductDetail/' + item.content_id)" class="btn btn-primary waves-effect waves-light">
