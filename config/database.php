...
return [
    ...
    'connections' => [
        ...
        'local_sqlite' => [
            'driver'   => 'sqlite',
            'database' => database_path(env('LOCAL_DB_DATABASE', 'db/database.sqlite')),
            'prefix'   => env('DB_PREFIX', ''),
        ],
        'tracker'      => [
            'driver'   => 'sqlite',
        ...
        'prod_mysql'   => [
            ...
            'database'    => env('DB_DATABASE', 'rketads2_test01'),
            'username'    => env('DB_USERNAME', 'rketads2_test01'),
            'password'    => env('DB_PASSWORD', 'rketads2?123'),
        ...
        'local_mysql'  => [
            ...
            'host'        => env('DB_HOST', '127.0.0.1'),
            'port'        => env('DB_PORT', 3306),
            'database'    => env('DB_DATABASE', 'roket_remotev1'),
